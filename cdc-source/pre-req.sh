...
mysql -uadmin -padmin123 -h $RDS_ENDPOINT -e "CREATE TABLE cdc.hotelcdcprices (city text, hotel text, batchId int DEFAULT NULL, price double DEFAULT NULL, timestamp timestamp NULL DEFAULT NULL, country text) ENGINE=InnoDB"
